...
public interface BanqueService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listCpmptes", targetNamespace = "http://ws/", className = "proxy.ListCpmptes")
    @ResponseWrapper(localName = "listCpmptesResponse", targetNamespace = "http://ws/", className = "proxy.ListCpmptesResponse")
    @Action(input = "http://ws/BanqueService/listCpmptesRequest", output = "http://ws/BanqueService/listCpmptesResponse")
